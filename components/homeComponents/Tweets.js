      ...
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">We work on different mining project that we offer to continrube with Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quia, itaque!</p>
          </div>
